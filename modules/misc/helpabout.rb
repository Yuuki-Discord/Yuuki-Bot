  ...
  module Misc
    ...
    Commandrb.commands[:help] = {
      code: proc {|event, _|
        ...
        event << "\n Or if you're looking to invite me to  your server, you can do it here: ** 🔗 #{YuukiBot.config['invite_url'].nil? ? event.bot.invite_url : config['invite_url']}**" if YuukiBot.config['show_invite']
      },
